...
if __name__ == '__main__':
    ...
    for bag_idx in range(num_bagging):
        ...
        meta_clf2.fit(X1, y1)
        pred_feat2 = meta_clf2.predict_proba(X2)
        meta_clf3.fit(X1, y1)
        pred_feat3 = meta_clf3.predict_proba(X2)
        ...
        test_pred_feat2 = meta_clf2.predict_proba(X_test)
        test_pred_feat3 = meta_clf3.predict_proba(X_test)
